...
\author{Jannetta S. Steyn \inst{1} \and Frances Turner \inst{1} \and Colin Sauze \inst{2} \and Abhishek Dasgupta \inst{3} \and Ethan P. White \inst{4} \and Samantha Finnigan \inst{5}}
		...
		\begin{columns}[t]
			...
			\begin{column}{\colwidth}
				\begin{alertblock}{Carpentries in your Pocket}
					...
					a microSD card is available. Once the image is written to the microSD card it can be inserted into the RPi and with no 
