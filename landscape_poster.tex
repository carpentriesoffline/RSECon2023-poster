...
\usepackage{xcolor}
\usepackage{lmodern}
\usepackage[orientation=portrait,size=a0,width=100,height=75,scale=1.0]{beamerposter}
\usetheme{gemini}
...
\begin{document}
	\addtobeamertemplate{headline}{}
	{
		\begin{tikzpicture}[remember picture,overlay]
			...
			{\includegraphics[width=10.0cm]{logos/OFFLINE.png}}; % also try shield-white.eps
